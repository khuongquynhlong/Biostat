...
<span style="color: #e73b2b;">**Method: the power will be first calculated for each sample size and effect size. Power values then will be fixed at approximately 0.8 to generate the graph of relationship between sample size and effect size**:</span> 
...
df_pwr_fix %>% 
  ...
  add_markers() %>% 
  layout(title = "Relationship between sample size and effect size, at power ~ 0.8",
         xaxis = list(title = "Effect size"),
         yaxis = list(title = "Sample size"),
         showlegend = FALSE)
```
