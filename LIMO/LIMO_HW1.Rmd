...
$F_t(.; n-p, \nu)$ is the CDF of a noncentral t-distribution with degrees of freedom and ncp $\nu$
...
df_pwr %>% filter(power >= 0.8 & power <0.81) %>% datatable(caption = "Table 2: Dataframe of sample size and effect size given powers are fixed at ~0.8")
